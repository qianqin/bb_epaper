...
const uint8_t ep133_init[] PROGMEM =
{
   ...
   6, 0x0c, 0xae, 0xc7, 0xc3, 0xc0, 0x80, // boost strength
   2, 0x18, 0x80, // enable internal temperature sensor
   11, 0x37, 0x00, 0x00, 0xf8, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, // display options (ping-pong disabled)
...
const uint8_t ep133_init_partial[] PROGMEM =
{
    ...
    4, 0x04, 0x41, 0xaa, 0x32, // set source voltage
    2, 0x11, 0x03, // data entry mode: X inc, Y inc
    2, 0x3c, 0x80, // border waveform = HiZ for partial refresh
    6, 0x0c, 0xae, 0xc7, 0xc3, 0xc0, 0x80, // boost strength
    2, 0x18, 0x80, // enable internal temperature sensor
    11, 0x37, 0x00, 0x00, 0xf8, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, // display options (ping-pong disabled)
    5, 0x44, 0x00, 0x00, 0xbf, 0x03, // x range: 0 to 959
...
const uint8_t epd75_old_gray_init_fast[] PROGMEM = {
...
// 20
    ...
    {800, 480, 0, epd75_gray_init, epd75_old_gray_init_fast, NULL, BBEP_4GRAY, BBEP_CHIP_UC81xx, u8Colors_4gray}, // EP75_800x480_4GRAY_GEN2
...
// 40
    ...
    {800, 480, 0, epd426g_init, epd426g_init_fast, NULL, BBEP_4GRAY | BBEP_NEEDS_EXTRA_INIT, BBEP_CHIP_SSD16xx, u8Colors_4gray}, // EP426_800x480_4GRAY
